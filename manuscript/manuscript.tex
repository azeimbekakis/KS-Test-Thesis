...
practical purposes. Figure~\ref{fig:pp_ssf} shows the results of the
...
procedure. \eds{I don't think AR(2) looks that bad?}
...
in the procedure in Section~\ref{sec:dependence} and an AR(1) dependence 
structure in the procedure in Section~\ref{sec:fittedwithdependence}. 
%Therefore, if the AR(1) dependence structure is a 
%close approximation of the truth, the approach can work.
%However, in cases such as AR(2) \eds{I still do not think AR(2) looks bad!}, if 

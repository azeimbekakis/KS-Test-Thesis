...
Science, in the context of residual diagnostics and testing whether the 
externally studentized residuals can be viewed as realizations of a standard 
normal distribution for large samples. The catalog description of this course 
states the following topics: ``Applied multiple 
...
one-way and two-way analysis of variance.'' Students in this course are required
to have taken either two semesters of introductory statistics or a 
Calculus~2-based statistical methods course as a prerequisite.  While students 
in the class are exposed to the bootstrap in the context of linear regression 
models, they are not in general familiar with serially dependency.  Thus, the 
remedies and more complicated serially dependent settings were not presented at 
the undergraduate level.  Serial dependence is covered in other
undergraduate courses, and in fact, the contents of this manuscript were the 
basis of AZ's undergraduate honors thesis. All concepts are certainly within 
reach of UConn undergraduate Statistics and Statistical Data Science majors.     
